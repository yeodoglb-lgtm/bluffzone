...
serve(async (req) => {
  ...
  try {
    ...
    const POKER_HINT = `포커 홀덤 Holdem. 프리플랍 Preflop, 플랍 Flop, 턴 Turn, 리버 River, 쇼다운. UTG 유티지 언더더건, MP 엠피, HJ 하이잭, CO 컷오프, BTN 버튼, SB 스몰블라인드, BB 빅블라인드. Ace 에이스, King 킹, Queen 퀸, Jack 잭, Ten 텐, Spade 스페이드, Heart 하트, Diamond 다이아, Club 클럽. AKo AKs 포켓페어 JJ TT. Fold 폴드, Check 체크, Call 콜, Bet 벳, Raise 레이즈, 3벳 쓰리벳, 4벳 포벳, 올인 Allin, 쇼브 Shove, 림프 Limp, 스트래들 Straddle. 씨벳 C-bet, 동크벳 Donk, 블러프 Bluff, 밸류벳, 세미블러프, 체크레이즈. 오버페어, 탑페어, 미들페어, 바텀페어, 셋 Set, 트립스 Trips, 드로우, 거트샷 Gutshot, 양방드로우 OESD, 플러시드로우, 풀하우스, 스트레이트플러시, 포카인드, 넛츠. GTO 지티오, 익스플로잇, 레인지, 에쿼티 Equity, EV 기댓값, SPR, 팟오즈, 이펙티브스택. 팟 Pot, 스택 Stack, 빅블, 만원, 십만원.`;
