...
### 구글폼 (STEP 4) — 운영자 작업
- forms.google.com에서 신규 폼 생성
- 문항: 매장명, 주소(도로명), 전화, 사진(최대 5장), 운영시간, 정기 토너 일정, 게임종류(NLH/PLO/OFC), 추가안내, 등록동의 체크
- 응답 → 자동 구글시트 연동
- 폼 링크 + 시트 링크 운영자가 Claude에 전달

### 메시지 문구 (STEP 5) — 구글폼 링크 받으면 확정
초안 (LMS ~130자):
```
[블러프존 매장 등록 안내]
안녕하세요, 홀덤 핸드 매니저 앱 '블러프존(bluffzone.kr)'입니다.
전국 홀덤 매장을 유저들에게 무료로 소개해드리고 있습니다.
귀 매장 등록을 원하시면 아래 링크로 사진·정보 보내주세요.
👉 [구글폼 링크]
문의: 010-XXXX-XXXX
수신거부: '거부' 회신
```
